...
// ====================================================================
// EXPORTS GLOBAIS - CHARACTER
// ====================================================================
window.updateAll = updateAll;
window.updateInitiative = updateInitiative;
window.updatePassivePerception = updatePassivePerception;
window.updateProfBonus = updateProfBonus;
window.updateNextLevelXP = updateNextLevelXP;
window.updateSpellStats = updateSpellStats;
window.updateHpBar = updateHpBar;
window.adjustHP = adjustHP;
window.applyHpDelta = applyHpDelta;
window.toggleInspiration = toggleInspiration;
window.onClassChange = onClassChange;
window.onRaceChange = onRaceChange;
window.updateClassBadges = updateClassBadges;
window.updateClassResource = updateClassResource;
window.updateRaceTraits = updateRaceTraits;
window.updateHitDice = updateHitDice;
window.autoSetSpellAbility = autoSetSpellAbility;
